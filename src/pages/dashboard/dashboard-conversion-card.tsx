...
import { formatPercent } from "./format-balance";
...
interface DashboardConversionCardProps {
  payInPct: number;
  payOutPct: number;
  appealsPct: number;
...
export function DashboardConversionCard({
  payInPct,
  payOutPct,
  appealsPct,
  period,
  onPeriodChange,
}: DashboardConversionCardProps) {
