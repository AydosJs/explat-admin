...
interface TokensTradersTableProps {
  table: TanStackTable<TokenTraderRow>;
}

export function TokensTradersTable({ table }: TokensTradersTableProps) {
