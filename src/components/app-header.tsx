...
const PATH_TO_TITLE_KEY: Record<string, string> = {
  ...
  "/pay-out/create": "common.create",
  "/merchants": "sidebar.merchants",
  "/merchants/create": "common.create",
  "/traders": "sidebar.traders",
  "/traders/create": "common.create",
  "/requisites": "sidebar.requisites",
  "/requisites/create": "common.create",
  "/devices": "sidebar.devices",
  "/devices/create": "common.create",
  "/appeals": "sidebar.appeals",
  "/appeals/create": "common.create",
  "/tokens/payouts": "sidebar.tokensPayouts",
  "/tokens/payouts/create": "common.create",
  "/tokens/balance": "sidebar.tokensBalance",
  "/tokens/balance/create": "common.create",
  "/tokens/traders": "sidebar.tokensTraders",
  "/tokens/traders/create": "common.create",
  "/bank-sms/banks": "sidebar.banks",
  "/bank-sms/banks/create": "common.create",
  "/bank-sms/sms-templates": "sidebar.smsTemplates",
  "/bank-sms/sms-templates/create": "common.create",
  "/bank-sms/sms-senders": "sidebar.smsSenders",
  "/bank-sms/sms-senders/create": "common.create",
  "/more/balance-logs": "sidebar.balanceLogs",
  "/more/balance-logs/create": "common.create",
  "/more/payment-reserve": "sidebar.paymentReserve",
  "/more/payment-reserve/create": "common.create",
};
